            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="library/nigeria.pdf" class="page-scroll">
                                <h3>Map</h3>
                            </a></li>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="main-heading-content col-md-12 col-sm-12 text-center">
                            ...
                            <p class="main-heading-text">WELCOME TO,<br />E - TICKETING FOR RAILWAY</p>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="main-heading-content col-md-12 col-sm-12 text-center">
                            ...
                            <h1 class="main-heading-title">Nigeria Railway Company Contact List</h1>

                            <p class="main-heading-text">The Nigerian Railway Corporation is 112 years old and it runs a
                                ...
                                <br />The Nigerian railway narrow gauge network is approximately 3,500 km long and is
                                currently being extended by a narrow gauge line between Onne and the Enugu - Port
        ...
        <footer class="site-footer section-spacing text-center " id="eight">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4"> <small>&copy; <?php echo date('Y'); ?>, Brought To You By <a
                                href="#"><?php echo $developer_name; ?></a> </small></div>
