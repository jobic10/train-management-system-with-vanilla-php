            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item has-treeview menu-open">
                            <a href="individual.php" class="nav-link active">
                        ...
                        <li class="nav-item">
                            <a href="individual.php?page=reg" class="nav-link">
                                <i class="fa fa-plus nav-icon"></i>
                                <p>New Booking</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="individual.php?page=paid" class="nav-link">
                                <i class="fa fa-book nav-icon"></i>
                                <p>View Bookings</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="individual.php?page=feedback" class="nav-link">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark"> Account Dashboard!</h1>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
            </div>
