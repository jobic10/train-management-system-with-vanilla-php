            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header alert-success">
                        <h5 class="m-0">List of all tickets</h5>
                    </div>
                    <div class="card-body">
                        <table class="table table-bordered" id='example1'>
                            ...
                            <tbody>
                                ...
                                while ($row = $conn->fetch_assoc()) {
                                    ...
                                    <td>" . $row['code'] . "</td>
                                    <td>" . $row['date'] . "</td>
                                    <td>" . ((isScheduleActive($row['schedule_id']) ? '<span class="text-bold text-success">Active' : '<span class="text-bold text-danger">Not Active')) . "</span></td>
                                    <td>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <?php
                                                    ...
                                                    else echo '<button disabled="disabled" class="btn btn-success">Ticket Expired</button>'; ?>
